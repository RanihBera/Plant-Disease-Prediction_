disease_info = {
    ...
    "Pepper Bell Healthy": {
        "Symptoms": [
            "Leaves are green and free from spots",
    ...
    "Potato Late Blight": {
        ...
        "Cause": "Caused by the pathogen Phytophthora infestans.",
        "Prevention": [
...
,
    ...
    "Tomato Spider Mites": {
        "Symptoms": [
            ...
            "Leaves become dry and curled"
        ],
        "Cause": "Caused by two-spotted spider mites.",
        "Prevention": [
    ...
    "Tomato Yellow Leaf Curl Virus": {
        ...
        "Cause": "Caused by Tomato Yellow Leaf Curl Virus (TYLCV), spread by whiteflies.",
        "Prevention": [
            "Control whiteflies",
            "Use resistant varieties",
    ...
    "Tomato Mosaic Virus": {
        ...
        "Prevention": [
            ...
            "Disinfect tools",
            "Avoid handling plants after tobacco products"
        ],
        "Treatment": [
            "Remove infected plants",
